        ...
        >
          ...
          <Flex alignItems={"center"}>
            <Menu>
              ...
              <MenuList>
                <Link to="/profil">
                  <MenuItem fontSize="medium">Profil</MenuItem>
                </Link>
                <MenuItem fontSize="medium">Ustawienia</MenuItem>
                <MenuDivider />
                <MenuItem fontSize="medium" onClick={() => logout()}>
                  Wyloguj się
                </MenuItem>
              </MenuList>
            </Menu>
    ...
    children: [
      {
        ...
        subLabel:
          "Załóż nową organizację i popraw swój kontakt z pracownikami!",
